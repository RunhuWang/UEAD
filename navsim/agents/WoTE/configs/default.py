...
class WoTEConfig:
    ...
    #sim_reward_dict_path: str = f'/home/fqz02/Works/WangRunhu/demo02/navsim_workspace/dataset/extra_data/planning_vb/formatted_pdm_score_{num_traj_anchor}.npy'
    sim_reward_dict_path: str = None
    cluster_file_path = f'/home/fqz02/Works/WangRunhu/demo02/navsim_workspace/dataset/extra_data/planning_vb/trajectory_anchors_{num_traj_anchor}.npy'
